...
variavel <- c("[60,70[", "[70,80[", "[80,90[","[90,100[", "[100,110[","[110,120[","[120,130[","[130,140[")
#informe os valores da frequência simples
fi <- c(1,5,6,10,12,19,14,3)
#informe os nomes das colunas
nomes.colunas <- c("Intervalo de Classe","Frequência")
...
Valores de Algumas Separatrizes
```{r}
knitr::kable(df.separatrizes)
```


Valores dos Coeficientes Estatísticos:
```{r}
knitr::kable(df.coeficientes)
```
...
```{r}
knitr::kable(df.classificaCurva)
```